                                                ...
                                                <header id="header" class="fixed-top d-flex align-items-center">
                                                  <div class="container d-flex align-items-center">
                                                    <h1 class="logo me-auto">
                                                      <a href="index.html">SAINT PATRICK<span></span>
                                                      </a>
                                                    </h1>
                                                    ...
                                                    <a href="index.html" class="logo me-auto">
                                                      ...
                                                      <nav id="navbar" class="navbar order-last order-lg-0">
                                                        <ul>
                                                          <li>
                                                            <a class="nav-link scrollto active" href="#hero">Transacción</a>
                                                          </li>
                                                          <li>
                                                            <a class="nav-link scrollto" href="#about">Saldo</a>
                                                          </li>
                                                          <li>
                                                            <a class="nav-link scrollto" href="#team">Historial</a>
                                                          </li>
                                                        </ul>
                                                    ...
                                                    <div class="container">
                                                      <div class="py-4">
                                                        ...
                                                        <section id="team" class="team section-bg">
                                                          <!-- .re utilice un id del index no se si es buen practica -->
                                                          <div class="container" data-aos="fade-up">

                                                            <div class="section-title" data-aos="zoom-out" data-aos-delay="500">
                                                              <h3>Transferencia</h3>
                                                            </div>

                                                            <div class="col-md-12" data-aos="zoom-out" data-aos-delay="1000">
                                                                      ...
                                                                      <label class="custom-control custom-radio">
                                                                        ...
                                                                        <div class="row">
                                                                          <div class="col-md-6 mb-3">
                                                                            ...
                                                                            <input name="cc-name" id="cc-name" class="form-control" required="required" placeholder="Ejemplo: Daniel Videla">
                                                                            ...
                                                                            <div class="col-md-6 mb-3">
                                                                              ...
                                                                              <input type="number" name="number" id="number" class="form-control" required="required" placeholder="xxxx - xxxx - xxxx - xxxx">>
                                                                            ...
                                                                            <div class="row">
                                                                              ...
                                                                              <div class="col-md-3 mb-3">
                                                                                ...
                                                                                <input type="number" name="expiration" id="expiration" class="form-control" required="required" placeholder="$">
                                                                                  <small class="text-muted">Ingrese monto, solo numeros</small>
                                                                                </div>
                                                                                <div class="col-md-3 mb-3">
                                                                                  <label for="codigoSeg">Codigo de Seguridad - Pin</label>
                                                                                  <input type="password" name="cvv" id="cvv" class="form-control" required="required">
                                                                        ...
                                                                        <p>
                                                                          ...
                                                                          <br>
                                                                            ...
                                                                            <div class="container d-md-flex py-4">
                                                                              <p>proyecto ID for ideas grupo 130</p>
                                                                              <!-- aca va el footer todavia no se que poner -->
                                                                            </div>
                                                                          </footer>
                                                                          <!-- End Footer -->
                                                                          <!-- aca va el footer todavia no se que poner -->
